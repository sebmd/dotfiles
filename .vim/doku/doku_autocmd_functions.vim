...
" FZF w $DOKU z podglądem zawartości pliku
command! -bang -nargs=? -complete=dir Doku
    \ call fzf#vim#files('$DOKU', fzf#vim#with_preview({'options': ['--layout=reverse', '--info=inline', '--prompt=Doku> ']}), <bang>0)
