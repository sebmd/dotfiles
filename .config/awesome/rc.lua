...
globalkeys = gears.table.join(
    ...
    awful.key({ }, "XF86AudioRaiseVolume",
        function () awful.util.spawn("/usr/bin/pactl set-sink-volume 0 +2%") end),
    ...
    awful.key({ modkey,           }, "c",
        function ()
            awful.util.spawn("bin/clipmenu")
        end,
        { description = "clipmenu", group = "skrypty" }
    ),
    ...
    awful.key({ modkey }, "x",
              function ()
                  awful.prompt.run {
                    prompt       = "Run Lua code: ",
                    nextbox      = awful.screen.focused().mypromptbox.widget,
